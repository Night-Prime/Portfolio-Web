...
const initializeDatabase = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        logger_1.default.info("Wanna see? : ", env);
        const sequelizeConfig = createSequelizeConfig(env);
        const sequelize = new sequelize_1.Sequelize(env.DB_NAME, env.DB_USER, env.DB_PASS, sequelizeConfig);
        ...
        logger_1.default.error('Failed to initialize database or run migrations:', error);
        process.exit(1);
    }
});
exports.initializeDatabase = initializeDatabase;
let sequelizeInstance = null;
const getSequelizeInstance = () => __awaiter(void 0, void 0, void 0, function* () {
